...
d=x(d);f=f.querySelector(".indent-mark");null!==f&&!1===h&&(g=+f.style.width.split("em")[0]/1.5,d=r(g)+"- "+d);null===f&&0<d.length&&"#"!==d[0]&&(d+="<br>");pageTexts.push(d)}((a="Title",b=[])=>{for(var c=`# ${a}\n`,e=0;e<b.length;e++)c+="\n"+b[e];b=window.open();b.document.open();b.document.write(`<title>${a}</title>`);b.document.write("<pre>");a=b.document;e=a.write;c=c.replace(/&/g,"&amp;");c=c.replace(/</g,"&lt;");c=c.replace(/>/g,"&gt;");c=c.replace(/"/g,"&quot;");c=c.replace(/'/g,"&#39;");e.call(a,
c);b.document.write("</pre>");b.document.close()})(y,pageTexts)})();
